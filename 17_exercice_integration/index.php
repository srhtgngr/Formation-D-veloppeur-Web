...
<body>
    <main>
                        ...
                        <div class="modal-first">
                            <form action="" method="post">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="password" class="form-control" id="inlineFormInputGroup1" placeholder="Password">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">Pass</div>
                                    </div>
                                    <input type="password" class="form-control" id="inlineFormInputGroup2" placeholder="Confirm Password">
                                </div>
                            </form>
                        </div>
        ...
        <div class="container-fluid">
            <nav class="container-fluid navbar navbar-expand-lg" id="navbar">
        ...
        <div class="container-fluid justify-content-between" id="">
        ...
        <div class="container-fluid" id="article">
            <div class="row">
                <div class="col-3">
                    <span class="titre">Group</span>
                    <p>
                        <h1>Lorem ipsum ...</h1> dolor sit amet consectetur adipisicing elit. Omnis blanditiis ipsam commodi quia id beatae fugit itaque non, hic facere ullam expedita rerum delectus sequi voluptates similique aliquam nihil aperiam.
                    </p>
                    <img class="img-responsive" src="media/200.png" alt="">
                    <p>
                        <h1>Lorem ipsum ...</h1> dolor sit amet consectetur adipisicing elit. Quam sequi magnam autem pariatur alias natus exercitationem minima, aliquid fuga itaque saepe iure quasi repellat nulla officia tenetur eaque veritatis possimus.
                    </p>
                    <img class="img-responsive" src="media/200.png" alt="">
                    <p>
                        <h1>Lorem ipsum ...</h1> dolor sit, amet consectetur adipisicing elit. Nihil ratione voluptatum repellat tempora sit ad eum, assumenda provident hic asperiores illo quasi, expedita, sapiente quae nostrum amet quisquam porro. Obcaecati!
                    </p>
                </div>
        ...
        <div class="container-fluid" id="footer">
            <div class="row">
                <div class="col-7">
                    <img src="media/dieudo.png" alt="" id="dieudo">
                    <p>
                        <h1>Lorem ipsum, dolor</h1> sit amet consectetur adipisicing elit. Consequuntur maxime a facere nostrum veniam ipsum magnam consequatur fuga? Iste reiciendis labore et assumenda impedit quibusdam voluptatibus fugit facilis aliquid quos.
                        Odio nemo vitae qui ut necessitatibus minus eos quam voluptate animi perferendis incidunt dolor impedit ea nisi corporis sequi, eum repellendus ab tenetur blanditiis. Quo, saepe ullam. Minus, aliquid at?
                        Quibusdam incidunt tenetur, est quae maiores assumenda itaque dolorum repellendus totam sunt fugit quos error et ut facilis eum laborum facere libero temporibus. Animi ad eos iusto saepe, pariatur officiis.
                    </p>
                </div>
                <div class="col" id=video>
                    <video src="media/video.mp4" autoplay controls loop muted></video>
                </div>
            </div>
        </div>
